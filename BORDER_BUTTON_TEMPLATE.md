# 🎬 Border Button Email Template

## ✅ **Button Style Updated:**
- ✅ Border button with perfect curve
- ✅ Red text on transparent background
- ✅ Hover: black text on red background

## 🎯 **Updated Template - Copy & Paste This:**
...
- **Red border** (`border: 2px solid #ff0000`)
- **Red text** (`color: #ff0000`)
- **Perfect curve** (`border-radius: 50px`)

### **✅ Hover State:**
- **Red background** (`background: #ff0000`)
- **Black text** (`color: #000000`)
- **Subtle lift** (`transform: translateY(-2px)`)
- **Red shadow** (`box-shadow: 0 6px 12px rgba(255, 0, 0, 0.4)`)

### **✅ Perfect Curve:**
- **`border-radius: 50px`** creates perfect oval/rounded rectangle
...
```
┌─────────────────────┐
│   Reset Password    │ ← Red text, transparent background, red border
└─────────────────────┘
```
...
```
┌─────────────────────┐
│   Reset Password    │ ← Black text, red background, red border
└─────────────────────┘
```
...
4. **Replace** everything with the border button template above
5. **Save** and test

---

**Perfect border button with red text, transparent background, and smooth hover transition!** 🎬

The button now has the exact style you requested with a perfect curve!
