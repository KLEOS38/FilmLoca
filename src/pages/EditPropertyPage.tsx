                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            id="description"
                            placeholder="Describe your property (minimum 10 words)"
                            rows={4}
